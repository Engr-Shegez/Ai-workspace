...
export function MarketingFooter() {
  return (
    <footer className="px-6 pb-10 pt-20">
      <div className="mx-auto max-w-7xl rounded-[2rem] border border-black/6 bg-white/70 p-8 shadow-[0_18px_50px_rgba(0,0,0,0.06)] dark:border-white/8 dark:bg-white/3 dark:shadow-none">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <p className="text-base font-semibold tracking-[-0.04em] text-zinc-950 dark:text-white">
              Threadline
            </p>
            <p className="mt-4 max-w-md text-md leading-7 text-zinc-600 dark:text-zinc-400">
        ...
        <div className="mt-10 border-t border-black/6 pt-6 text-md text-zinc-500 text-center dark:border-white/8">

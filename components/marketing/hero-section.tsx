...
const heroStats = [
  { label: "Shared context", value: "One thread for drafts, decisions, and notes" },
  { label: "Team ready", value: "Built for product, ops, support, and research" },
    ...
    <section className="relative overflow-hidden px-6 pb-24 pt-20 sm:pb-28 sm:pt-24">
      <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.02fr_0.98fr]">
        <Reveal className="relative">
          <div className="inline-flex items-center rounded-full border border-emerald-700/15 bg-emerald-500/10 px-4 py-2 text-xs font-medium uppercase tracking-[0.24em] text-emerald-800 dark:border-emerald-200/15 dark:bg-emerald-200/8 dark:text-emerald-100/85">

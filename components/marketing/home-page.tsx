...
export function MarketingHomePage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f6f4ef] text-zinc-900 dark:bg-[#090909] dark:text-zinc-100">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(24,24,27,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(24,24,27,0.05)_1px,transparent_1px)] bg-size-[5rem_5rem] opacity-[0.18] mask-[linear-gradient(to_bottom,white,transparent_85%)] dark:bg-[linear-gradient(rgba(255,255,255,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.04)_1px,transparent_1px)] dark:opacity-[0.08]" />

          ...
          {features.map((feature, index) => {
            ...
            return (
              <Reveal
                key={feature.title}
                delay={index * 0.05}
                className="group rounded-[2rem] border border-black/6 bg-white/70 p-6 shadow-[0_18px_40px_rgba(0,0,0,0.05)] transition hover:-translate-y-1 hover:border-black/10 hover:bg-white dark:border-white/8 dark:bg-white/[0.035] dark:shadow-none dark:hover:border-white/14 dark:hover:bg-white/[0.05]"
              >
